 ...
 * @author estagio2
 */
public class BackgroundBarView extends javax.swing.JFrame {

    /**
     * Creates new form BackgroundBarView
     */
    Semaphore s = null;
    ...
    public BackgroundBarView(){
        initComponents();
    }
    
    public BackgroundBarView(String barClub, int qntCadeiras) {
        super(barClub);
        initComponents();
        ...
        casa[0] = "/imagens/casa-backgrounds/casa1.jpg";
        casa[1] = "/imagens/casa-backgrounds/casa2.jpg";
        casa[2] = "/imagens/casa-backgrounds/casa3.jpg";
        casa[3] = "/imagens/casa-backgrounds/casa4.jpg";
        casa[4] = "/imagens/casa-backgrounds/casa5.jpg";
        casa[5] = "/imagens/casa-backgrounds/casa6.jpg";
        casa[6] = "/imagens/casa-backgrounds/casa7.jpg";
        casa[7] = "/imagens/casa-backgrounds/casa8.jpg";
        casa[8] = "/imagens/casa-backgrounds/casa9.jpg";
        casa[9] = "/imagens/casa-backgrounds/casa10.jpg";
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource(bar[qntCadeiras - 1])));
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource(casa[qntCadeiras - 1])));
        setSize(1360, 450);
    ...
    private void initComponents() {
        ...
        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/casa-backgrounds/casa10.jpg"))); // NOI18N
...
//            this.cliente1.setText("Cliente 1");        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BackgroundBarView.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BackgroundBarView().setVisible(true);
            }
        });
    }
